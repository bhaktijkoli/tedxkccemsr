            ...
            <div className="section-body">
              <div className="row">
                ...
                <div className="col-sm-12">
                  ...
                  <span>TEDxKCCEMSR is an independently organised TEDx event by K.C College Of Engineering And Management studies And Research. The scope of the event is to provide a platform where community-driven people can showcase their ideas and elevating them to a global stage. </span>
                </div>
                <div className="col-sm-12">
